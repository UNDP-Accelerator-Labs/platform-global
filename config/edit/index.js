...
exports.apps_in_suite = [
	{ name: 'Action plans', key: process.env.NODE_ENV === 'production' ? 'action_plans_platform' : 'ap_test_02', baseurl: 'https://acclabs-actionlearningplans.azurewebsites.net/' },
	{ name: 'Solutions mapping', key: process.env.NODE_ENV === 'production' ? 'solutions_mapping_platform' : 'sm_test_02', baseurl: 'https://acclabs-solutionsmapping.azurewebsites.net/' },
	{ name: 'Experiments', key: process.env.NODE_ENV === 'production' ? 'experiments_platform' : 'exp_test_02', baseurl: 'https://acclabs-experiments.azurewebsites.net/' }
